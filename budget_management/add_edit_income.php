...
$income = $db->query("SELECT * FROM income")->fetchAll();
?><!DOCTYPE html>
<html  >
    <head>
		...
		<div class="row justify-content-center">
		    <div class="col-lg-12 mx-auto mbr-form form-col md-pb">
                        <div class="form-wrap" data-form-type="formoid">
                            <form action="process_add_income.php" method="POST" class="mbr-form form-with-styler col-lg-6 mx-auto" data-form-title="Form Name">
				...
				?>
				    ...
				    <div class="col-sm-12 form-group">
                                        <input type="text" name="income[name]" placeholder="Name" value="<?php echo $update ? $incomeInfo['name'] : ""; ?>" class="form-control display-7" required="required" />
                                    </div>
				    <div style="clear: both"></div><br/>
					<div class="col-sm-12 form-group">
                                        <input type="number" name="income[amount]" placeholder="Amount" value="<?php echo $update ? $expenseInfo['amount'] : ""; ?>" class="form-control display-7" required="required" />
                                    </div>
				    <div style="clear: both"></div><br/>
